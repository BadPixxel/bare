...
/**
 * LlxSupplierProposaldet
 *
 * @ORM\Table(name="llx_supplier_proposaldet", indexes={@ORM\Index(name="idx_supplier_proposaldet_fk_supplier_proposal", columns={"fk_supplier_proposal"}), @ORM\Index(name="idx_supplier_proposaldet_fk_product", columns={"fk_product"}), @ORM\Index(name="fk_supplier_proposaldet_fk_unit", columns={"fk_unit"})})
 * @ORM\Entity
 */
class LlxSupplierProposaldet
{
    ...
    /**
     * @var \Dolibarr\Core\CoreBundle\Entity\LlxSupplierProposal
     *
     * @ORM\ManyToOne(targetEntity="Dolibarr\Core\CoreBundle\Entity\LlxSupplierProposal")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="fk_supplier_proposal", referencedColumnName="rowid")
     * })
     */
    private $fkSupplierProposal;
