 ...
 * LlxCommandedet
 *
 * @ORM\Table(name="llx_commandedet", indexes={@ORM\Index(name="idx_commandedet_fk_commande", columns={"fk_commande"}), @ORM\Index(name="idx_commandedet_fk_product", columns={"fk_product"}), @ORM\Index(name="fk_commandedet_fk_unit", columns={"fk_unit"})})
 * @ORM\Entity
 */
class LlxCommandedet
{
    ...
    /**
     * @var \Dolibarr\Core\CoreBundle\Entity\LlxCommande
     *
     * @ORM\ManyToOne(targetEntity="Dolibarr\Core\CoreBundle\Entity\LlxCommande")
     * @ORM\JoinColumns({
