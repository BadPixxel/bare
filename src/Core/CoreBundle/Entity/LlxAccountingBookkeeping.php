...
/**
 * LlxAccountingBookkeeping
 *
 * @ORM\Table(name="llx_accounting_bookkeeping", indexes={@ORM\Index(name="idx_accounting_bookkeeping_doc_date", columns={"doc_date"}), @ORM\Index(name="idx_accounting_bookkeeping_fk_doc", columns={"fk_doc"}), @ORM\Index(name="idx_accounting_bookkeeping_fk_docdet", columns={"fk_docdet"}), @ORM\Index(name="idx_accounting_bookkeeping_numero_compte", columns={"numero_compte"}), @ORM\Index(name="idx_accounting_bookkeeping_code_journal", columns={"code_journal"})})
 * @ORM\Entity
 */
class LlxAccountingBookkeeping
{
     ...
     * @var string
     *
     * @ORM\Column(name="numero_compte", type="string", length=32, nullable=false)
     */
