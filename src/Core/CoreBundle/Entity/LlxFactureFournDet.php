 ...
 * LlxFactureFournDet
 *
 * @ORM\Table(name="llx_facture_fourn_det", indexes={@ORM\Index(name="idx_facture_fourn_det_fk_facture", columns={"fk_facture_fourn"}), @ORM\Index(name="idx_facture_fourn_det_fk_product", columns={"fk_product"}), @ORM\Index(name="idx_facture_fourn_det_fk_code_ventilation", columns={"fk_code_ventilation"}), @ORM\Index(name="fk_facture_fourn_det_fk_unit", columns={"fk_unit"})})
 * @ORM\Entity
 */
class LlxFactureFournDet
{
     ...
     * @var float|null
     *
     * @ORM\Column(name="pu_ht", type="float", precision=24, scale=8, nullable=true)
     */
    private $puHt;
     ...
     * @var float|null
     *
     * @ORM\Column(name="pu_ttc", type="float", precision=24, scale=8, nullable=true)
     */
    private $puTtc;
     ...
     * @var float|null
     *
     * @ORM\Column(name="tva", type="float", precision=24, scale=8, nullable=true)
     */
    private $tva;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="fk_facture_fourn", referencedColumnName="rowid")
     * })
     */
